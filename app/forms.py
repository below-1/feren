...
from app.models import Anggota, Pinjaman, Pegawai, Sex
...
class CreatePegawaiForm(forms.Form):
    nama = forms.CharField(label="Nama Pegawai")
    jabatan = forms.CharField(label="Jabatan")
    username = forms.CharField(label="Username")
    password = forms.CharField(label="Password")
    email = forms.EmailField(label="email")
    sex = forms.ChoiceField(label="Jenis Kelamin", choices=Sex.choices)
